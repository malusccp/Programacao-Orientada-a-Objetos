...
do {
    ...
    switch (opcao) {
        case "01": inserirConta(); break;
        case "02": consultarConta(); break;
        case "03": sacar(); break;
        case "04": depositar(); break;
        case "05": excluirConta(); break;
        case "06": transferir(); break;
        case "07": mudarTitularidade(); break;
        case "08": transferirParaMuitas(); break;

        case "10": obterQuantidadeContas(); break;
        case "11": obterTotalDepositado(); break;
        case "12": obterMediaSaldo(); break;
        case "13": listarContasSemCliente(); break;

        case "20": inserirCliente(); break;
        case "21": consultarCliente(); break;
        case "22": associarContaCliente(); break;
        case "23": excluirCliente(); break;
        case "24": listarContasClientes(); break;
        case "25": totalizarSaldoCliente(); break;
...
function inserirConta(): void {
    console.log("\n--- Cadastrar Conta ---");
    let idStr: string = input('Digite o ID (numérico) da conta: ');
    let numero: string = input('Digite o número (ex: 123-A): ');
    let saldoStr: string = input('Digite o saldo inicial: ');
...
function consultarConta(): void {
    ...
    let conta: Conta | undefined = b.consultarPorNumero(numero);
...
function excluirConta(): void {
    console.log("\n--- Excluir Conta ---");
    let numero: string = input('Digite o número da conta a excluir: ');
...
function transferir(): void {
    console.log("\n--- Transferir ---");
    let numOrigem: string = input('Digite a conta de ORIGEM: ');
    let numDestino: string = input('Digite a conta de DESTINO: ');
    let valorStr: string = input('Digite o valor: ');
...
function transferirParaMuitas(): void {
    console.log("\n--- Transferência em Lote (Ordem) ---");
    let numOrigem: string = input('Digite a conta de ORIGEM: ');
    let valorStr: string = input('Digite o valor (fixo) para CADA transferência: ');
    let contasDestinoStr: string = input('Digite os números das contas de destino (separados por vírgula): ');

    let contasDestino: string[] = contasDestinoStr.split(',');
...
function inserirCliente(): void {
    console.log("\n--- Cadastrar Cliente ---");
    let idStr: string = input('Digite o ID (numérico) do cliente: ');
    let nome: string = input('Digite o nome: ');
    let cpf: string = input('Digite o CPF (ex: 123.456.789-00): ');
    let dataStr: string = input('Data de Nascimento (AAAA-MM-DD): ');
...
function consultarCliente(): void {
    ...
    let cliente: Cliente | undefined = b.consultarCliente(cpf);
...
function excluirCliente(): void {
    console.log("\n--- Excluir Cliente ---");
    let cpf: string = input('Digite o CPF do cliente a excluir: ');
...
function listarContasClientes(): void {
